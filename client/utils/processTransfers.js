import { getPurseBalance } from "./priceUtil";
import { getPlayerData } from './playerUtil';
import _ from 'lodash';


export const processTransfers = (transfers, league) => {
    ...
    if(transfers && league){
        ...
        output.map((transfer)=> {
            ...
            if(currentUser){
                ...
                let player = getPlayerData(transfer.transferIn.playerId);
        ...
        console.log("Updated League --->", users);
    }
